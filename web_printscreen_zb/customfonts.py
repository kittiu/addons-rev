...
CustomTTFonts = [ ('Helvetica',"DejaVu Sans", "DejaVuSans.ttf", 'normal'),
        ...
        ('THSarabun',"THSarabun", "THSarabun.ttf", 'normal'),
        ('THSarabun',"THSarabun Bold", "THSarabun Bold.ttf", 'bold'),
        ('THSarabun',"THSarabun Bold Italic", "THSarabun Bold Italic.ttf", 'bolditalic'),
        ('THSarabun',"THSarabun Italic", "THSarabun Italic.ttf", 'italic'),
...
TTFSearchPath_Linux = [
            ...
            '%s/fonts' % (os.path.dirname(os.path.realpath(__file__)), ),
            ]
